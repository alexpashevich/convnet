...
def run_kaggle_cnn(datetime_string, cnn_load_path = None, val_ind_path = None):
    ...
    X_train, y_train = data_augmentation(X_train, y_train, rotation_angle=7) # does not yield any significant (or even noticable) imporvments, maybe give it another try
